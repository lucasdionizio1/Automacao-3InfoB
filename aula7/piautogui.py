...
while True:
    ...
    try:
        ...
        xy = pyautogui.locateCenterOnScreen('aula7\\seta_scroll.png', confidence=0.8)
        #clica na imagem
        pyautogui.click(xy)
        break
    except:
...
#clica no botão escrver
xy = pyautogui.locateCenterOnScreen(
    'aula7\\escrever.png', confidence=0.95)
pyautogui.click(xy)
...
xy = pyautogui.locateCenterOnScreen(
    'aula7\\enviar.png', confidence=0.95)
pyautogui.click(xy)     
